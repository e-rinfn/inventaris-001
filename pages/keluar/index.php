...
<div class="main-content">
    ...
    <div class="page-header">
        ...
        <a href="tambah.php" class="btn btn-success">+ Tambah Peminjaman</a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="action-btns">
                                    <a href="edit.php?id=<?= $item['id_keluar'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="hapus.php?id=<?= $item['id_keluar'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus data ini?')">Hapus</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
