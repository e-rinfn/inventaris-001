...
<div class="sidebar" id="sidebar">
  ...
  <ul>
    ...
    <li><a href="<?= $base_url ?>/pages/kategori/index.php" class="<?= isActive('/kategori') ?>">🏷️ Kategori</a></li>
    ...
    <li><a href="<?= $base_url ?>/pages/laporan/transaksi.php" class="<?= isActive('/laporan/transaksi') ?>">📑 Laporan Barang</a></li>
